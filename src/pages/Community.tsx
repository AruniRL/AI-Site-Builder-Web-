        ...
        <div className='py-10 min-h-[80h]'>
          ...
          <div className='flex flex-wrap gap-3.5'>
           {projects.map((project)=>(
            <Link to={`/view/${project.id}`} key={project.id} target='_blank' className=' w-72 max-sm:mx-auto
            cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg
            overflow-hidden group hover:border-indigo-800/80 transition-all duration-300'>
             ...
             to-transparent transition-colors'>
               ...
               <div className='flex justify-between items-center mt-6'>
                  ...
                  <div className='flex gap-3 text-white text-sm'>
                     <button className='px-3 py-1.5bg-white/10
